        ...
        <div class="row">
            ...
            @else
                ...
                @if (!empty($response_for_chart))
                    ...
                    <div
                        class="chart-container{{ $response_for_chart['chart'] == 'pie_chart' ? ' text-center' : '' }}">
                        <div class="{{ $response_for_chart['chart'] == 'pie_chart' ? 'display-inline-block' : 'chart' }}"
                            id="{{ $response_for_chart['name'] }}"></div>
                    </div>
                @endif
            @endif
        </div>
